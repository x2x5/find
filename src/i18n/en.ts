...
export const en: Translations = {
  ...
  footer: {
    slogan: "Find top papers",
    totalVisits: "Visits",
    totalSearches: "Searches",
    featureRequest: "Want a feature?",
  ...
  timeline: {
    ...
    deadline: "Submission",
    result: "Acceptance",
    disclaimer: "Approximate dates, subject to change each year",
    monthLabels: [
      "Jan",
      "Feb",
      "Mar",
  ...
  cart: {
    ...
    rateLimit:
      "GitHub API rate limited: {searched}/{total} queries, {found} found, {blocked} blocked",
    rateLimitNoToken:
      "GitHub API rate limited: {searched}/{total} queries, add a Token",
    queryFailed:
      "GitHub query failed: {failed} failed, checked {searched}/{total}",
  ...
  wordCloud: {
    ...
    emptyWithPapers:
      "No word cloud data. Try different filters on the main page.",
