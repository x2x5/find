...
export default function Header({ searchValue, onSearchChange, onSearch }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 max-w-7xl mx-auto">
      <div className="px-4 py-3 flex items-center justify-between gap-4 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
